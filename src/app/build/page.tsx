...
export const metadata = {
  title: "Build · Prism",
  description:
    "Build lenses — reason through code, architecture, and engineering choices. Powered by MiMo V2.5 Pro.",
};

export default function BuildPage() {
  const lenses = getLensesByCategory("build");
  return (
