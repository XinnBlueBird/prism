...
export const metadata = {
  title: "Decide · Prism",
  description:
    "Decide lenses — stress-test decisions before you commit to them. Powered by MiMo V2.5 Pro.",
};

export default function DecidePage() {
  const lenses = getLensesByCategory("decide");
  return (
    <PageShell active="/decide">
        ...
        <div className="mb-10 flex items-end justify-between gap-6 max-md:flex-col max-md:items-start">
          <div>
            ...
            <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl">
              {CATEGORIES.decide.label}
            </h1>
            <p className="mt-3 max-w-xl text-white/60">
              {CATEGORIES.decide.description}
            </p>
          </div>
